...
export default function SummaryBox({ item }) {
  return (
    <Box>
      <div className="summary-box">
        <div className="summary-box__info">
          ...
          <div className="summary-box__info__vlaue">{item.value}</div>
        </div>
...
export function SummaryBoxSpecial({ item }) {
  const chartOptions = {
    responsive: true,
    scales: {
      xAxis: {
    ...
    <Box purple fullheight>
      <div className="summary-box-special">
        ...
        <div className="summary-box-special__chart">
          <Line options={chartOptions} data={chartData} width={`250px`}></Line>
        </div>
      </div>
    </Box>
  );
